...
/*
 * $Id: CommonUI.java,v 1.20 1999/05/21 23:04:15 davidson Exp $
 */
...
public class CommonUI {
    ...
    // Buttons
    public static final String BUTTONTEXT_ADD = I18NMessages.getMessage("commonui.add");
    public static final String BUTTONTEXT_APPLY = I18NMessages.getMessage("commonui.apply");
    public static final String BUTTONTEXT_EDIT = I18NMessages.getMessage("commonui.edit");
    public static final String BUTTONTEXT_NEW = I18NMessages.getMessage("commonui.new");
    public static final String BUTTONTEXT_REMOVE = I18NMessages.getMessage("commonui.remove");
    public static final String BUTTONTEXT_OK = I18NMessages.getMessage("commonui.ok");
    public static final String BUTTONTEXT_CANCEL = I18NMessages.getMessage("commonui.cancel");
    public static final String BUTTONTEXT_CLOSE = I18NMessages.getMessage("commonui.close");
    public static final String BUTTONTEXT_NEXT = I18NMessages.getMessage("commonui.next");
    public static final String BUTTONTEXT_BACK = I18NMessages.getMessage("commonui.back");
    public static final String BUTTONTEXT_FINISH = I18NMessages.getMessage("commonui.finish");
    public static final String BUTTONTEXT_MOVEUP = I18NMessages.getMessage("commonui.move_up");
    public static final String BUTTONTEXT_MOVEDOWN = I18NMessages.getMessage("commonui.move_down");
