/*
 * @(#)ViewPropertyAction.java	1.2 99/10/01
 *
...
/**
 * Two state action which toggles the display of the property panel
 *
 * @version 1.2 10/01/99
 * @author  Mark Davidson
 */
public class ViewPropertyAction extends AbstractItemAction  
                                implements BeanActionConstants {

    private BeantestActionManager manager;

    public ViewPropertyAction(BeantestActionManager manager) {
        this.manager = manager;
        
        putValue(Action.NAME, CMD_NAME_PROP);
        putValue(Action.SHORT_DESCRIPTION, CMD_SHORT_DESCRIPTION_PROP);
        putValue(Action.LONG_DESCRIPTION, CMD_LONG_DESCRIPTION_PROP);
        putValue(Action.MNEMONIC_KEY, new Integer(CMD_MNEMONIC_PROP));
