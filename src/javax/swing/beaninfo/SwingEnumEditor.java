...
public class SwingEnumEditor extends SwingEditorSupport implements ActionListener {
    ...
    public void init(PropertyDescriptor descriptor) {
        Object[] enum1 = (Object[])descriptor.getValue( "enumerationValues" );
        if (enum1 != null) {
            if (combobox == null)  {
            ...
            for ( int i = 0; i < enum1.length; i += 3 ) {
                combobox.addItem(new EnumeratedItem((Integer)enum1[i+1], (String)enum1[i] ) );
            }
